...
struct MenuBarView: View {
    ...
    /// Production callers use the parameterless default; tests inject a
    /// `MenuBarViewModel` to control permission state and observe the
    /// `openMainView` / `quit` notifications.
